...
class Partie:
    ...
    def initialiser_joueurs(self):
        ...
        """
        joueur_noir = self.demander_type_joueur("noir")
        joueur_blanc = self. demander_type_joueur("blanc")
    ...
    def demander_type_joueur(self, couleur):
        ...
        """
        if couleur == "noir":
            joueur_couleur_noir = input(
                "Quel type de joueur désirez-vous pour la couleur noir? Entrez Humain ou Ordinateur.")

            while joueur_couleur_noir != "Ordinateur":
                if joueur_couleur_noir != "Humain":
                    joueur_couleur_noir = input("Le type entré est invalide. Les choix sont Humain et Ordinateur.")
                else:
                    break
            return self.creer_joueur(joueur_couleur_noir, "noir")
        else:
            joueur_couleur_blanc = input(
                "Quel type de joueur désirez-vous pour la couleur blanche? Entrez Humain ou Ordinateur.")

            while joueur_couleur_blanc != "Ordinateur":
                if joueur_couleur_blanc != "Humain":
                    joueur_couleur_blanc = input("Le type entré est invalide. Les choix sont Humain et Ordinateur.")
                else:
                    break
            return self.creer_joueur(joueur_couleur_blanc, "blanc")
    ...
    def creer_joueur(self, type, couleur):
        ...
        if type == "Humain":
            ...
            if couleur == "noir":
                return JoueurOrdinateur("noir")
            else:
                return JoueurOrdinateur("blanc")
    ...
    def passer_tour(self):
        ...
        """
        print("Le joueur {} ne peut pas jouer. Il passe son tour.".format(self.couleur_joueur_courant))
